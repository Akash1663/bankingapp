...
<body>
    ...
    <div class="container">
        ...
        <button class="back-to-login" onclick="window.location.href='customer_index.jsp'">Back to Login</button>
    </div>
</body>
</html>
